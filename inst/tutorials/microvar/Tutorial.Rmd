...
### Data Preprocessing 
We will perform sample preprocessing using FastQC, Trim Galore, Bowtie2, and Samtools, 
followed by reference-based taxonomy classification using Kraken2 and Bracken.
...
wunifrac = plotBetaDiversity(phyloseq = shotgun,
                             condition_col = "condition", 
                             condition_label = c("Fl", "Fl_Arg"), 
                             colors = c('#FFA726','#26A69A'), 
                             measure ="wunifrac",
